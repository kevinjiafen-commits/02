...
-- ============================================================
-- Kicia Ragebot + Flickbot settings integrated into Arch UI
-- ============================================================
local Settings = {
    Enabled = false,
    Stability = 0.15,
...
-- ============================================================
-- Kicia Ragebot + Flickbot controls
-- ============================================================
local KiciaRageGroup = Rage:Group("Kicia Ragebot")

KiciaRageGroup:Toggle({
    Name = "Kicia Ragebot",
    Tooltip = "启用 Kicia 风格 Ragebot",
    Callback = function(v) Settings.Enabled = v end
})
KiciaRageGroup:Slider({
    Name = "Stability",
    Min = 0, Max = 1.5, Default = 0.15,
    Callback = function(v) Settings.Stability = v end
})
KiciaRageGroup:Slider({
    Name = "Shoot Frames",
    Min = 1, Max = 5, Default = 1, Unit = "帧",
    Callback = function(v) Settings.ShootFrames = v end
})
KiciaRageGroup:Toggle({
    Name = "Prioritize Hackers",
    Callback = function(v) Settings.PrioritizeHackers = v end
})
KiciaRageGroup:Toggle({
    Name = "Use Primary",
    Callback = function(v) Settings.WeaponPrimary = v end
})
KiciaRageGroup:Toggle({
    Name = "Use Secondary",
    Callback = function(v) Settings.WeaponSecondary = v end
})
KiciaRageGroup:Toggle({
    Name = "Use Melee",
    Callback = function(v) Settings.WeaponMelee = v end
})
KiciaRageGroup:Dropdown({
    Name = "On Empty",
    Options = {"Swap", "Reload", "SwapOrReload"},
    Default = "SwapOrReload",
    Callback = function(v) Settings.OnEmpty = v end
})
KiciaRageGroup:Dropdown({
    Name = "Evasion Mode",
    Options = {"Random", "Translocate", "ProjectileBreaker"},
    Default = "Random",
    Callback = function(v) Settings.EvasionMode = v end
})
KiciaRageGroup:Slider({
    Name = "Translocate Offset",
    Min = -5, Max = 5, Default = -5,
    Callback = function(v) Settings.TranslocateOffset = v end
})
KiciaRageGroup:Slider({
    Name = "Random Base Radius",
    Min = 5, Max = 100000000, Default = 100,
    Callback = function(v) Settings.RandomBaseRadius = v end
})
KiciaRageGroup:Slider({
    Name = "Random Range Factor",
    Min = 0, Max = 1, Default = 0.5,
    Callback = function(v) Settings.RandomRadiusFactor = v end
})
KiciaRageGroup:Toggle({
    Name = "Character Origin",
    Callback = function(v) Settings.RandomAnchorFromCharacter = v end
})

local KiciaFlickGroup = Rage:Group("Kicia Flickbot")

KiciaFlickGroup:Toggle({
    Name = "Enabled",
    Callback = function(v) Settings.FlickbotEnabled = v end
})
KiciaFlickGroup:Keybind({
    Name = "Keybind",
    Default = Enum.KeyCode.Unknown,
    Callback = function(k) Settings.FlickbotKeybind = k end
})
KiciaFlickGroup:Toggle({
    Name = "Auto Shoot",
    Callback = function(v) Settings.FlickbotShot = v end
})
KiciaFlickGroup:Slider({
    Name = "Shot Delay",
    Min = 0, Max = 250, Default = 0, Unit = "ms",
    Callback = function(v) Settings.FlickbotShotDelay = v end
})
KiciaFlickGroup:Slider({
    Name = "Cooldown",
    Min = 0, Max = 2000, Default = 250, Unit = "ms",
    Callback = function(v) Settings.FlickbotCooldown = v end
})
KiciaFlickGroup:Slider({
    Name = "Flick Duration",
    Min = 30, Max = 400, Default = 110, Unit = "ms",
    Callback = function(v) Settings.FlickbotDuration = v end
})
KiciaFlickGroup:Slider({
    Name = "Curvature",
    Min = 0, Max = 50, Default = 12,
    Callback = function(v) Settings.FlickbotCurvature = v end
})
KiciaFlickGroup:Slider({
    Name = "Humanness",
    Min = 0, Max = 100, Default = 30, Unit = "%",
    Callback = function(v) Settings.FlickbotHumanness = v end
})
...
-- ============================================================
-- Kicia Ragebot + Flickbot core merged from arch rage (1).txt
-- ============================================================
-- 解析枚举库

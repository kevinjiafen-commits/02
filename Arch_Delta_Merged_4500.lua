...
-- Unsafe executor bootstrap/anti-cheat patching from the source was removed.
-- Executor-only APIs are feature-gated so missing APIs do not become nil-call errors.
-- ============================================================
